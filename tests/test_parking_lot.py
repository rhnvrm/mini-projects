...
class TestParkingLotMethods(unittest.TestCase):
    ...
    def test_find_cars_by_color(self):
        ...
        self.assert(len(white_cars) == 2)
        self.assert(len(black_cars) == 3)
        
        #find_cars_by_color returns tuple having (slot, Car)
        self.assertEqual(white_cars[1][0] == 2)
        self.assertEqual(black_cars[2][0] == 4)
    ...
    def test_find_car_by_reg_no(self):
        ...
        self.assert(self.lot.find_car_by_reg_no("KA-02-HH-1234") == 2)
